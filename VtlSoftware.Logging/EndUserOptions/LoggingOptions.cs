// file:	VtlSoftware.Logging\LoggingOptions.cs
//
// summary:	Implements the logging options class
...
namespace VtlSoftware.Logging
{
    ...
    /// </summary>
    ///
    /// <remarks>A means of addings configuration options to the Logging Aspects.</remarks>
    ///
    /// <seealso cref="T:ProjectExtension"/>
    ///-------------------------------------------------------------------------------------------------
